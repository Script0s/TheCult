  ...
  return (
    <div className="navigation">
      <div className="nav-left">
        <Link to="/thecult/menu" className={`menu navLink${toggleClassCheck}`}>
          MENU
        </Link>
        <Link to="/thecult/bookings" className={`booking navLink${toggleClassCheck}`}>
          BOOKING
        </Link>
        <Link
          to="/thecult/forguests"
      ...
      <div className="nav-right">
        <Link to="/thecult/ourstory" className={`ourStory navLink${toggleClassCheck}`}>
          OUR STORY
        </Link>
        <Link
          to="/thecult/#contactFooter"
